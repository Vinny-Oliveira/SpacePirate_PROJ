	...
	*/
	...
	public class ClayObject : MonoBehaviour{
		...
		void updateSingle(){
			...
			solid.scale.x = (this.transform.lossyScale.x / container.transform.lossyScale.x) * 0.5f;
			solid.scale.y = (this.transform.lossyScale.y / container.transform.lossyScale.y) * 0.5f;
			solid.scale.z = (this.transform.lossyScale.z / container.transform.lossyScale.z) * 0.5f;
